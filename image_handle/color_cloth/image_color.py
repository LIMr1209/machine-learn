...
def CIE2000_distance(lab1, lab2):
    ...
    T = (
        1
        - 0.17 * math.cos((h_mean - 30) * math.pi / 180.0)
...
class ImageColor:
    ...
    def tailoring(self):
        if self.param:
            self.img = self.img[
                self.param["top"] : self.param["top"] + self.param["height"],
    ...
    def color_recognition(self, expected_size=40, in_clusters=7, out_clusters=3):
        ...
        (
            ...
            border_labels,
            border_probs,
        ) = em_border.trainEM(border_samples)
...
if __name__ == "__main__":
    image_color = ImageColor(
        url="https://p4.taihuoniao.com/image/200604/5ed884d0b43a865a292112c5"
    )
