...
# wdsr-a train
# python main.py --model  wdsr_a --save WDSR_A_BIX4 --scale 4  --save_results --patch_size 192 --n_feats 128
# python main.py --model  wdsr_a --load WDSR_A_BIX4 --scale 4 --resume -1 --save_results --patch_size 192 --n_feats 128
# wdsr-b train
# python main.py --model  wdsr_b --save WDSR_B_BIX4 --scale 4  --save_results --patch_size 192 --n_feats 128
# python main.py --model  wdsr_b --load WDSR_B_BIX4 --scale 4 --resume -1 --save_results --patch_size 192 --n_feats 128
#  Test your own images  测试自己的图片  wdsr-a
python main.py --data_test Demo --scale 4 --model  wdsr_a --pre_train  ../experiment/WDSR_A_BIX4/model/model_best.pt --test_only --save_results --patch_size 192 --n_feats 128
# python main.py --data_test Demo --scale 4 --model  wdsr_b --pre_train  ../experiment/WDSR_B_BIX4/model/model_best.pt --test_only --save_results --patch_size 192 --n_feats 128
