...
if __name__ == '__main__': 
    ...
    parser.add_argument('-c', '--class_label', type=int, choices=range(0, 1000), default=445)
    parser.add_argument('-w', '--pretrained_weight', type=str, default='biggan512-release.pt')
